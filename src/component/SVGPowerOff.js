...
const SVGPowerOff = () => {
	return(
		<svg version="1.1" id="_x32_" x="0px" y="0px" viewBox="0 0 512 512">
			<style type="text/css" />
			<path className="d1" d="M423.262,91.992c-16.877-15.91-43.434-15.098-59.32,1.778c-15.894,16.877-15.098,43.434,1.779,59.32
			...
			<path className="d2" d="M256,268.59c23.178,0,41.967-15.033,41.967-33.574V33.574C297.967,15.033,279.178,0,256,0
